  ...
  return (
    <>
      ...
      <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between 
        ...
        <a href="#top">
          <Image src={isDarkMode ? assets.logo_dark : assets.logo} alt="Logo" className="w-20 cursor-pointer mr-14" />
        </a>
        ...
        <ul className={`hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 ${isScroll ? "" : 
          ...
          <li><a className='font-Ovo' href="#work">Portfolio</a></li>
        ...
        bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-500 dark:bg-darkHover dark:text-white'>
          ...
          <li><a className='font-Ovo' onClick={closeMenu} href="#work">Portfolio</a></li>
